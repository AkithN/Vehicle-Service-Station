...
import TextField from '@mui/material/TextField'; // Importing Material-UI's TextField
  ...
  return (
    <div className="register">
      ...
      >
        ...
        <Form.Item
          label="Operating Hours (Weekdays)"
          name="operatingHoursWeek"
        ...
        <Form.Item
          label="Operating Hours (Weekends)"
          name="operatingHoursWeekend"
          rules={[{ required: true, message: 'Please select time' }]}
        >
          <Radio.Group>
        ...
        <Form.Item
          label="Do You Work On Public Holidays?"
          name="publicHoliday"
        ...
        <Form.Item
          label="Availability Of Emergency Or 24/7 Service"
        ...
        <Form.Item
          label="Service Station Scale"
          name="serviceScale"
          rules={[{ required: true, message: 'Please select scale of service station' }]}
        >
          <Select placeholder="--Select--">
        ...
        <Form.Item
          label="Description Of The Garage"
